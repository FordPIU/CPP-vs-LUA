...
void printsl(string printMessage)
{
    if (lastLineType == 1)
    {
        cout << "\n";
    };
    cout << "\033[F\r" << printMessage;
    lastLineType = 0;
}
void printsl(int printNum)
{
    if (lastLineType == 1)
    {
        cout << "\n";
    };
    cout << "\033[F\r" << to_string(printNum);
    lastLineType = 0;
}
...
int NumOfMathSpeedTests = 50;
int NumOfAlgoSpeedTests = 50;
int main()
{
    print("\n\n-----------------------------------------------");
    print("-----------------------------------------------");
